...
var Tile2 = function Tile2(props) {
  ...
  var getText = function getText(txt) {
    console.log('getText', txt);
    return txt.split('##').map(function (item, key) {
      return __jsx("span", {
        key: key,
        __source: {
...
//# sourceMappingURL=[projectid].js.cee6168d1c4094e969e0.hot-update.js.map